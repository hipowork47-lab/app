          ...
          >
            ...
            {userRole === "admin" && (
              <>
                ...
                <TabsTrigger
                  value="invoices"
                  className="flex-col gap-1 flex-shrink-0 min-w-[150px] sm:min-w-[160px] md:min-w-0 md:h-full md:justify-center data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-purple-500 data-[state=active]:text-white snap-start"
                >
            ...
            <TabsTrigger
              ...
              className="flex-col gap-1 flex-shrink-0 min-w-[150px] sm:min-w-[170px] md:min-w-0 md:h-full md:justify-center data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-purple-500 data-[state=active]:text-white snap-start"
            >
