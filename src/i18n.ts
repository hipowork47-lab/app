...
const resources = {
  es: {
    translation: {
      ...
      print: "Imprimir",
      syncNow: "Sincronizar",
      licenseInvalid: "La clave de licencia no es válida o ya está registrada en este dispositivo",
      createAccount: "Crear cuenta",
      accountCreateTitle: "Crear una nueva cuenta",
      accountUsername: "Nombre de usuario",
      accountPassword: "Contraseña",
      accountRole: "Rol",
      accountRoleAdmin: "Administrador",
      accountRoleEmployee: "Empleado",
      accountCreateConfirm: "Guardar cuenta",
      accountCreateSuccessTitle: "Cuenta creada",
      accountCreateSuccessDesc: "La cuenta {{username}} se creó correctamente",
      accountCreateError: "Ingresa usuario y contraseña",
      licenseKey: "Clave de licencia",
      licenseKeyPlaceholder: "Ingrese la clave de licencia",
      licenseDevices: "Dispositivos vinculados",
      licenseDevicesTitle: "Dispositivos activos",
      licenseDevicesCount: "{{used}} / {{max}} dispositivos",
      buyLicense: "Comprar licencia",
      buyLicenseTitle: "Comprar licencia",
      buyBasicInfo: "Información básica",
      buyFullName: "Nombre completo",
      buyStoreName: "Nombre de la tienda / empresa",
      buyPhoneOptional: "Teléfono (opcional)",
      buyEmail: "Correo electrónico",
      buyLicenseInfo: "Detalles de la licencia",
      buyLicenseType: "Tipo de licencia",
      buyLicenseTrial: "Prueba",
      buyLicenseLifetime: "De por vida",
      buyDeviceCount: "Dispositivos permitidos",
      buyDevicesOption: "{{count}} dispositivo(s)",
      buyDevicesUnlimited: "Ilimitado",
      buyUsageType: "Tipo de uso",
      buyUsageSingle: "Una tienda",
      buyUsageMulti: "Varias sucursales",
      buyPaymentInfo: "Información de pago",
      buyPaymentMethod: "Método de pago",
      buyPaymentManual: "Transferencia manual",
      buyPaymentPayPal: "PayPal",
      buyPaymentUSDT: "USDT / Cripto",
      buyPaymentCash: "Efectivo",
      buyNotesOptional: "Notas del cliente (opcional)",
      buySubmit: "Enviar solicitud",
      buyRequiredError: "Complete los campos obligatorios antes de enviar",
      syncSuccess: "Sync completada",
      syncSuccessDesc: "Datos actualizados desde el servidor",
      changeCurrencyButton: "¿Quieres cambiar la moneda?",
      currencyNote: "La moneda base se usa para cálculos; la secundaria solo para mostrar o comparar con el tipo de cambio.",
      currencyChangeWarning: "Esto cambiará la moneda base y la moneda secundaria en toda la aplicación.",
      primaryCurrency: "Moneda base",
      secondaryCurrency: "Moneda secundaria",
      syncFailed: "Falla de sincronización",
      syncFailedDesc: "Verifica tu conexión e intenta de nuevo",
      ...
      giftButton: "Regalo",
      giftDialogTitle: "Registrar regalo",
      giftRecipientLabel: "Nombre del destinatario (opcional)",
      giftRecipientPlaceholder: "Ej: cliente VIP",
      giftProductLabel: "Selecciona producto",
      giftProductPlaceholder: "Elige un producto",
      giftQuantityLabel: "Cantidad",
      giftConfirm: "Confirmar",
      giftErrorSelectTitle: "Error",
      giftErrorSelectDesc: "Selecciona un producto",
      giftErrorMissingTitle: "Error",
      giftErrorMissingDesc: "Producto no encontrado",
      giftErrorStockTitle: "Inventario insuficiente",
      giftErrorStockDesc: "La cantidad solicitada excede el inventario",
      ...
      purchaseRateNote: "Tipo de cambio {{rate}} {{secondary}}/{{primary}}",
      errorTitle: "Error",
  ...
  ar: {
    translation: {
      ...
      print: "طباعة",
      syncNow: "مزامنة الآن",
      licenseInvalid: "مفتاح التفعيل غير صالح أو مسجل مسبقاً على هذا الجهاز",
      createAccount: "إنشاء حساب",
      accountCreateTitle: "إنشاء حساب جديد",
      accountUsername: "اسم المستخدم",
      accountPassword: "كلمة المرور",
      accountRole: "الدور",
      accountRoleAdmin: "مسؤول",
      accountRoleEmployee: "موظف",
      accountCreateConfirm: "حفظ الحساب",
      accountCreateSuccessTitle: "تم إنشاء الحساب",
      accountCreateSuccessDesc: "تم إنشاء الحساب {{username}} بنجاح",
      accountCreateError: "أدخل اسم المستخدم وكلمة المرور",
      licenseKey: "مفتاح التفعيل",
      licenseKeyPlaceholder: "أدخل مفتاح التفعيل",
      licenseDevices: "الأجهزة المربوطة",
      licenseDevicesTitle: "الأجهزة المرتبطة بالمفتاح",
      licenseDevicesCount: "{{used}} / {{max}} جهاز",
      buyLicense: "شراء مفتاح",
      buyLicenseTitle: "شراء مفتاح",
      buyBasicInfo: "المعلومات الأساسية",
      buyFullName: "الاسم الكامل",
      buyStoreName: "اسم المتجر / الشركة",
      buyPhoneOptional: "رقم الهاتف (اختياري)",
      buyEmail: "البريد الإلكتروني",
      buyLicenseInfo: "معلومات الترخيص",
      buyLicenseType: "نوع الترخيص",
      buyLicenseTrial: "تجريبي",
      buyLicenseLifetime: "مدى الحياة",
      buyDeviceCount: "عدد الأجهزة المسموح",
      buyDevicesOption: "{{count}} جهاز/أجهزة",
      buyDevicesUnlimited: "غير محدود",
      buyUsageType: "نوع الاستخدام",
      buyUsageSingle: "متجر واحد",
      buyUsageMulti: "عدة فروع",
      buyPaymentInfo: "معلومات الدفع",
      buyPaymentMethod: "طريقة الدفع",
      buyPaymentManual: "تحويل يدوي",
      buyPaymentPayPal: "PayPal",
      buyPaymentUSDT: "USDT / Crypto",
      buyPaymentCash: "نقدي",
      buyNotesOptional: "ملاحظات من العميل (اختياري)",
      buySubmit: "إرسال الطلب",
      buyRequiredError: "يرجى ملء الحقول المطلوبة قبل الإرسال",
      syncSuccess: "تمت المزامنة بنجاح",
      syncSuccessDesc: "تم تحديث البيانات من الخادم",
      changeCurrencyButton: "هل تريد تغيير العملة؟",
      currencyNote: "العملة الأساسية للحسابات، والمعادِلة للعرض أو المقارنة حسب سعر الصرف.",
      currencyChangeWarning: "سيتم تغيير العملة الأساسية والعملـة المعادِلة في كل البرنامج.",
      primaryCurrency: "العملة الأساسية",
      secondaryCurrency: "العملة المعادِلة",
...
// الفواتير
      ...
      giftButton: "هدية",
      giftDialogTitle: "تسجيل هدية",
      giftRecipientLabel: "اسم الجهة (اختياري)",
      giftRecipientPlaceholder: "مثال: عميل VIP",
      giftProductLabel: "اختر المنتج",
      giftProductPlaceholder: "اختر المنتج",
      giftQuantityLabel: "الكمية",
      giftConfirm: "إتمام العملية",
      giftErrorSelectTitle: "خطأ",
      giftErrorSelectDesc: "يرجى اختيار المنتج",
      giftErrorMissingTitle: "خطأ",
      giftErrorMissingDesc: "المنتج غير موجود",
      giftErrorStockTitle: "المخزون غير كافٍ",
      giftErrorStockDesc: "الكمية المطلوبة أكبر من المخزون",
      ...
      purchaseRateNote: "سعر الصرف {{rate}} {{secondary}}/{{primary}}",
      errorTitle: "خطأ",
  ...
  en: {
    translation: {
      ...
      print: "Print",
      syncNow: "Sync now",
      licenseInvalid: "License key is invalid or already registered on this device",
      createAccount: "Create account",
      accountCreateTitle: "Create a new account",
      accountUsername: "Username",
      accountPassword: "Password",
      accountRole: "Role",
      accountRoleAdmin: "Admin",
      accountRoleEmployee: "Employee",
      accountCreateConfirm: "Save account",
      accountCreateSuccessTitle: "Account created",
      accountCreateSuccessDesc: "Account {{username}} created successfully",
      accountCreateError: "Please enter username and password",
      licenseKey: "License key",
      licenseKeyPlaceholder: "Enter license key",
      licenseDevices: "Linked devices",
      licenseDevicesTitle: "Active devices for this key",
      licenseDevicesCount: "{{used}} / {{max}} devices",
      buyLicense: "Buy license",
      buyLicenseTitle: "Purchase license",
      buyBasicInfo: "Basic information",
      buyFullName: "Full name",
      buyStoreName: "Store / company name",
      buyPhoneOptional: "Phone number (optional)",
      buyEmail: "Email",
      buyLicenseInfo: "License details",
      buyLicenseType: "License type",
      buyLicenseTrial: "Trial",
      buyLicenseLifetime: "Lifetime",
      buyDeviceCount: "Allowed devices",
      buyDevicesOption: "{{count}} device(s)",
      buyDevicesUnlimited: "Unlimited",
      buyUsageType: "Usage type",
      buyUsageSingle: "Single store",
      buyUsageMulti: "Multiple branches",
      buyPaymentInfo: "Payment info",
      buyPaymentMethod: "Payment method",
      buyPaymentManual: "Manual transfer",
      buyPaymentPayPal: "PayPal",
      buyPaymentUSDT: "USDT / Crypto",
      buyPaymentCash: "Cash",
      buyNotesOptional: "Customer notes (optional)",
      buySubmit: "Send request",
      buyRequiredError: "Please fill the required fields before sending",
      ...
      currencyChangeWarning: "This will change the base and secondary currency across the entire app.",
      ...
      giftButton: "Gift",
      giftDialogTitle: "Record gift",
      giftRecipientLabel: "Recipient name (optional)",
      giftRecipientPlaceholder: "e.g. VIP customer",
      giftProductLabel: "Select product",
      giftProductPlaceholder: "Choose a product",
      giftQuantityLabel: "Quantity",
      giftConfirm: "Confirm",
      giftErrorSelectTitle: "Error",
      giftErrorSelectDesc: "Please choose a product",
      giftErrorMissingTitle: "Error",
      giftErrorMissingDesc: "Product not found",
      giftErrorStockTitle: "Not enough stock",
      giftErrorStockDesc: "Requested quantity exceeds stock",
      ...
      purchaseRateNote: "Exchange rate {{rate}} {{secondary}}/{{primary}}",
      errorTitle: "Error",
